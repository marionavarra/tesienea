...
class ClassificationsControllerTest < ActionController::TestCase
  ...
  test "should create classification" do
    assert_difference('Classification.count') do
      post :create, classification: { elettrica: @classification.elettrica, guasto: @classification.guasto, idrica: @classification.idrica, maltempo: @classification.maltempo, manutenzione: @classification.manutenzione, notizia: @classification.notizia, stradale: @classification.stradale, telecomunicazioni: @classification.telecomunicazioni }
    end
  ...
  test "should update classification" do
    patch :update, id: @classification, classification: { elettrica: @classification.elettrica, guasto: @classification.guasto, idrica: @classification.idrica, maltempo: @classification.maltempo, manutenzione: @classification.manutenzione, notizia: @classification.notizia, stradale: @classification.stradale, telecomunicazioni: @classification.telecomunicazioni }
    assert_redirected_to classification_path(assigns(:classification))
  end
