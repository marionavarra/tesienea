...
file_dizionario = File.open("dizionario2.txt", "w")
...
linee_dizionario.each do |word_old|
  file_dizionario.write word_old.split[0] + " " + word_old.split[0] + "\n"
  file_dizionario.flush
  linee_lemmi.each do |linea|
    if linea.split[0]==word_old.split[0]
      file_dizionario.write linea.split[1] + " " + word_old.split[0] +"\n"
      file_dizionario.flush
